...
namespace ManageSchedule
{
    public partial class FormMonthView : Form
    {
        ...
        public FormMonthView(DateTime _date)
        {
            ...
            listMonth = new List<OneDay>(DayOfMonth(dateMonth));
            dateMonth = _date;
            LoadMatrix();
            isFromOutSide = false;
        }
        ...
        void LoadMatrix()
        {
            ...
            AddDayIntoMatrix(DateTime.Now, false);
        }
        ...
        void AddDayIntoMatrix(DateTime date, bool flag)
        {
            ...
            for (int i = 1; i <= DayOfMonth(date); i++)
            {
                ...
                {
                    Label lbl = new Label();
                    lbl.Click += LblOfDay_Click;
                    btn.Controls.Add(lbl);
                    lbl.AutoSize = false;
                    lbl.Width = btn.Width;
                    lbl.Font = btnMonday.Font;
                    lbl.Text = i.ToString();
                    ...
                    if (index != -1)
                    {
                        SetLabelForOneDay(ref btn, listMonth[index]);
                    }
                }
                else
                {
        ...
        private void LblOfDay_Click(object sender, EventArgs e)
        {
        ...
        private void LoadEventForMatrix()
        {
            ...
            sqlGet.Parameters["@username"].Value = FormDangNhap.username;
        ...
        private void SetLabelForOneDay(ref FlowLayoutPanel pnl, OneDay oneDay)
        {

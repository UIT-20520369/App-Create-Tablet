...
{
    public partial class EditSuKien : Form
    {
        ...
        public EditSuKien(DateTime dateTime)
        {
            InitializeComponent();
            ...
            cbRepeat.SelectedItem = "Không lặp lại";
            isMinSize = true;
        }

        public EditSuKien(OneEvent suKien)
        {
            InitializeComponent();
            ItemEvent = suKien;
        ...
        private void MaxSize()
        {
            ...
            this.Size = new Size(this.Width, pnlTittle.Height + pnlMore.MaximumSize.Height + btnSave.Height + 5);
            pnlTotal.Size = new Size(pnlTittle.Width, this.Size.Height);
            flPnlMore.Size = new Size(flPnlMore.Width, pnlMore.MaximumSize.Height + btnSave.Height + 5);
        ...
        private void MinSize()
        {
            ...
            flPnlMore.Size = new Size(flPnlMore.Width, pnlMore.Height + btnSave.Height + 5);
        ...
        private void InsertIntoTableSK()
        {
            ...
            sqlIns.Parameters["@username"].Value = FormDangNhap.username;
        ...
        private void InsertIntoTHONGBAO()
        {
            ...
            {
                SqlCommand sqlInsertTB = new SqlCommand($"insert into dbo.THONGBAO (USERNAME, IDSK, GIATRI, DONVI) values (@username, @id, @giatri, @donvi)", sqlCon);
                sqlInsertTB.Parameters.Add("@username", SqlDbType.VarChar);
                sqlInsertTB.Parameters["@username"].Value = FormDangNhap.username;
                sqlInsertTB.Parameters.Add("@id", SqlDbType.Int);
                sqlInsertTB.Parameters["@id"].Value = ItemEvent.ID;
                sqlInsertTB.Parameters.Add("@giatri", SqlDbType.Int);
                sqlInsertTB.Parameters["@giatri"].Value = ItemEvent.ListTB[i].GiaTri;
                sqlInsertTB.Parameters.Add("@donvi", SqlDbType.NChar);
                sqlInsertTB.Parameters["@donvi"].Value = ItemEvent.ListTB[i].DonVi;
                //try
                //{
